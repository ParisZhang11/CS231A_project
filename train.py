        ...
        for config in validation_configs:
            if config['cameras'] and len(config['cameras']) > 0:
                ...
                with open(txt_path,"a") as fp:
                    print(f"{iteration}_{config['name']}_{psnr_test:.6f}_{ssim_test:.6f}_{lpips_test:.6f}", file=fp)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[30000])# default=([1, 250, 500,]+ [i*1000 for i in range(1,31)]))
